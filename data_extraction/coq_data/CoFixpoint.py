...
@VernacBase.register_subclass("CoFixpoint")
class VernacCoFixpoint(VernacBase):
    @classmethod
    def from_string(cls, lines: List[str], category: str) -> 'VernacCoFixpoint':
...
@ConstrBase.register_subclass("CoFixpoint")
class ConstrCoFixpoint(ConstrBase):
    pass
