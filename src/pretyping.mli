...
*)
val print_type : Environ.env -> Evd.evar_map -> Names.Id.t -> EConstr.t -> string 

val print_constr : 
  Environ.env -> Evd.evar_map -> EConstr.t -> unit  

val print_pure_constr :
  Environ.env -> Evd.evar_map -> EConstr.t -> unit

val print_type_func : Environ.env -> Evd.evar_map -> Names.Id.t -> EConstr.t -> unit

val print_type_func_with_keyword : Environ.env -> Evd.evar_map -> Names.Id.t -> EConstr.t -> string -> unit

val print_constr_title : string -> unit 

val print_constr_end : string -> unit 
